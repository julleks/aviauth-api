resource "aws_cloudfront_distribution" "docs-cloudfront" {
  ...
  origin {
    ...
    s3_origin_config {
      origin_access_identity = aws_cloudfront_origin_access_identity.docs-cloudfront-identity.cloudfront_access_identity_path
    }
  }
...
resource "aws_cloudfront_origin_access_identity" "docs-cloudfront-identity" {
